...
function preload(){
  mario_running = loadAnimation("scott1.png","scott2.png","scott3.png","scott4.png");
  mario_collided = loadAnimation("scottdead.png");
  groundImage = loadImage("backg.jpg");
  backgroundImg = loadImage("background.jpg");
  coinImage = loadImage("Gemi.png");
  obstacle2 = loadImage("zom2.png");
  obstacle1 = loadImage("zom1.png");
  obstacle3 = loadImage("zom3.png");
